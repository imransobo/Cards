...
function stvaranjeKarti() {
    ...
    var arrLjutko = [];
    for (var i = 0; i < 4; i++) {
        var randomBr1 = Math.floor(Math.random() * (24 - 1) + 1)                                     
    ...
    arr.forEach((item, i) => {
        if (arrSmjesko.includes(i)) {
            arr[i] = {
                ...item,
                value: 1000,
            }
        } else if (arrLjutko.includes(i)) {                                   
            arr[i] = {
                ...item,
                value: 0,
    ...
    CurrentDiv.innerHTML = arr.map(function (a, i) {                 
